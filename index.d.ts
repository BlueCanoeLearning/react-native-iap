 ...
 */
export declare const requestPurchase: (sku: string, andDangerouslyFinishTransactionAutomaticallyIOS?: boolean | undefined, developerIdAndroid?: string | undefined, accountIdAndroid?: string | undefined) => Promise<ProductPurchase>;
/**
 * Request a purchase for product. This will be received in `PurchaseUpdatedListener`.
 * @param {string} sku The product's sku/ID
 * @param {boolean} [andDangerouslyFinishTransactionAutomaticallyIOS] You should set this to false and call finishTransaction manually when you have delivered the purchased goods to the user. It defaults to true to provide backwards compatibility. Will default to false in version 4.0.0.
 ...
 * @returns {Promise<void>}
 */
export declare const requestSubscription: (sku: string, andDangerouslyFinishTransactionAutomaticallyIOS?: boolean | undefined, oldSkuAndroid?: string | undefined, prorationModeAndroid?: ProrationModesAndroid | undefined, developerIdAndroid?: string | undefined, userIdAndroid?: string | undefined) => Promise<SubscriptionPurchase>;
/**
 * Request a purchase for product. This will be received in `PurchaseUpdatedListener`.
 * @param {string} sku The product's sku/ID
 * @returns {Promise<void>}
 ...
 */
export declare const finishTransaction: (purchase: ProductPurchase, isConsumable?: boolean | undefined, developerPayloadAndroid?: string | undefined) => Promise<string | void>;
/**
 ...
 */
export declare const acknowledgePurchaseAndroid: (token: string, developerPayload?: string | undefined) => Promise<void | PurchaseResult>;
/**
 * Consume a product (on Android.) No-op on iOS.
 * @param {string} token The product's token (on Android)
 * @returns {Promise<PurchaseResult>}
 */
export declare const consumePurchaseAndroid: (token: string, developerPayload?: string | undefined) => Promise<PurchaseResult>;
/**
 ...
 */
export declare const validateReceiptIos: (receiptBody: object, isTest?: boolean | undefined) => Promise<false | Apple.ReceiptValidationResponse>;
/**
 ...
 */
export declare const validateReceiptAndroid: (packageName: string, productId: string, productToken: string, accessToken: string, isSub?: boolean | undefined) => Promise<false | object>;
/**
...
declare const iapUtils: {
    ...
    acknowledgePurchaseAndroid: (token: string, developerPayload?: string | undefined) => Promise<void | PurchaseResult>;
    consumePurchaseAndroid: (token: string, developerPayload?: string | undefined) => Promise<PurchaseResult>;
    validateReceiptIos: (receiptBody: object, isTest?: boolean | undefined) => Promise<false | Apple.ReceiptValidationResponse>;
    validateReceiptAndroid: (packageName: string, productId: string, productToken: string, accessToken: string, isSub?: boolean | undefined) => Promise<false | object>;
    requestPurchase: (sku: string, andDangerouslyFinishTransactionAutomaticallyIOS?: boolean | undefined, developerIdAndroid?: string | undefined, accountIdAndroid?: string | undefined) => Promise<ProductPurchase>;
    ...
    finishTransaction: (purchase: ProductPurchase, isConsumable?: boolean | undefined, developerPayloadAndroid?: string | undefined) => Promise<string | void>;
    requestSubscription: (sku: string, andDangerouslyFinishTransactionAutomaticallyIOS?: boolean | undefined, oldSkuAndroid?: string | undefined, prorationModeAndroid?: ProrationModesAndroid | undefined, developerIdAndroid?: string | undefined, userIdAndroid?: string | undefined) => Promise<SubscriptionPurchase>;
